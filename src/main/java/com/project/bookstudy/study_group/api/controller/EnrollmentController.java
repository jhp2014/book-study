...
public class EnrollmentController {
    ...
    public CreateEnrollmentResponse createEnrollment(@RequestBody EnrollmentCreateRequest request) {
        Long enrollmentId = enrollmentService.enroll(request.getMemberId(), request.getStudyGroupId());
